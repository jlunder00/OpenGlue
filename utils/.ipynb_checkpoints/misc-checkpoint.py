...
# def generate_random_subset(referenceF, newF, percentUsed):
#     with open(referenceF, 'r') as fin, open(newF, 'w') as fout:
#         fout.writelines([line for line in fin if random.random() <= percentUsed])

# def randomly_sample(dir, test_train_split):
