...
class BaseAcrobatPairsDataset(torch.utils.data.Dataset):
    def __init__(self, root_path, scenes_list, max_pairs_per_scene=None, overlap=None):
        ...
        print(str(self.scene_pairs_numbers))
    ...
    #TODO: Modify this/modify a copy such that overlap and camera params are not utilized, or modify camera params to be relevant to microscopy tools used
    def __getitem__(self, idx):
